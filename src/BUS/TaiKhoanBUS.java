    ...
    public boolean checkPASSWORD(String t) {
        if (t.length() < 8) {
            JOptionPane.showMessageDialog(null,
                    "Mật khẩu phải có ít nhất 8 kí tự!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        ...
        if (!t.matches(regex)) {
            JOptionPane.showMessageDialog(null,
                    "<html>Mật khẩu chỉ được chứa kí tự số, chữ hoa<br>Chữ thường, kí tự đặc biệt: !, @</html>", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        return true;
    }

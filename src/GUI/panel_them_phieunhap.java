...
//                panel_con_nhapsanpham.kiem_tra_trung_sanpham();
        k++;
        ...
        jl[5] = new JLabel("Tổng tiền : " + tongtien +" Đ");
        ...
        /////////////////////////////// nút hủy //////////////////////
        jl[7] = new JLabel("Hủy", JLabel.CENTER);
...
//    for (panel_con_nhapsanpham h : ds) {
//        chitietphieunhap_DTO ctpn = h.return_chitietphieunhap();
//        
//        // Kiểm tra nếu mã sản phẩm hoặc mã size chưa có giá trị thì bỏ qua
//        if (ctpn.getMasp() == null || ctpn.getMasp().isEmpty() || ctpn.getMasize() == null || ctpn.getMasize().isEmpty()) {
//            continue; // Bỏ qua kiểm tra nếu chưa có thông tin
//        }
//
//        ds_ctpn.add(ctpn);
...
//            if (ds_ctpn.get(i).getMasp().equals(ds_ctpn.get(j).getMasp()) &&
//                ds_ctpn.get(i).getMasize().equals(ds_ctpn.get(j).getMasize())) {
//                return true; // Có sản phẩm bị trùng
//            }
//        }
//    }
//    return false; // Không có sản phẩm nào trùng
//}
...
//	}
    public void update_chitietsanpham() throws SQLException {
        for (panel_con_nhapsanpham h : ds) {
            System.err.println("danh sách"+ds);
...
//		return this.r[0];
//	}
//        private String getcreateMAPN() {
//        int max =0;
//            ArrayList<phieunhap_DTO> pn=new phieunhap_BUS().getList();
//        for(int i=0;i<pn.size();i++){
//            String MANCClast = pn.get(i).getMAPN();
